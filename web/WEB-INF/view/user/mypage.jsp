				...
				<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
					...
					<div id="Precautions">
						<div id="Precautions-text">
							<div>* 닉네임은 변경 시점 30일 이후로 변경이 가능합니다.</div>
							<div>* 다른 문제 발생시 고객센터로 문의 해주십시오.</div>
							<div>* 이메일 인증, 휴대폰인증을 완료 해주십시오.</div>
							<div>* 본인 명의 휴대폰으로 인증 해주십시오.</div>
							<div>* Level을 활성 조건(휴대폰 인증, 이메일 인증)</div>
							<div>* 담당자 김대용(eodyd0313@gmail.com)</div>
						</div>
					</div>
                </div>
            </div>
            <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
                <div id="header-password">
                    ...
                    <form action="/user/mypage/password" method="post" id="password-frm">
                        <div>
                            <label>현재 비밀번호 : <input type="password" name="currentupw"></label>
                        </div>
                        <div>
                            <label>변경 비밀번호 : <input type="password" name="upw"></label>
                        </div>
                        <div>
                            <label>확인 비밀번호 : <input type="password" id="confirmupw"></label>
                        </div>
                        <div>
